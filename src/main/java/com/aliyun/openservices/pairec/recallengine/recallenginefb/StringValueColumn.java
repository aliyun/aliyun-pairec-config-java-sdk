...
public final class StringValueColumn extends Table {
  ...
  public static StringValueColumn getRootAsStringValueColumn(ByteBuffer _bb, StringValueColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public StringValueColumn __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startStringValueColumn(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public StringValueColumn get(int j) { return get(new StringValueColumn(), j); }
    public StringValueColumn get(StringValueColumn obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
