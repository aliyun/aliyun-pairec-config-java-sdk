...
public final class MultiUInt8Value extends Table {
  ...
  public static MultiUInt8Value getRootAsMultiUInt8Value(ByteBuffer _bb, MultiUInt8Value obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public MultiUInt8Value __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startMultiUInt8Value(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public MultiUInt8Value get(int j) { return get(new MultiUInt8Value(), j); }
    public MultiUInt8Value get(MultiUInt8Value obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
