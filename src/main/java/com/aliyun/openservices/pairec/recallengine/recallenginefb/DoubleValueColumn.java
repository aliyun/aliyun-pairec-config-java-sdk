...
public final class DoubleValueColumn extends Table {
  ...
  public static DoubleValueColumn getRootAsDoubleValueColumn(ByteBuffer _bb, DoubleValueColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public DoubleValueColumn __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startDoubleValueColumn(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public DoubleValueColumn get(int j) { return get(new DoubleValueColumn(), j); }
    public DoubleValueColumn get(DoubleValueColumn obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
