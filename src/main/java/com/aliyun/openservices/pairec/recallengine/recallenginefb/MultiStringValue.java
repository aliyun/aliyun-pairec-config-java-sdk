...
public final class MultiStringValue extends Table {
  ...
  public static MultiStringValue getRootAsMultiStringValue(ByteBuffer _bb, MultiStringValue obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public MultiStringValue __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startMultiStringValue(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public MultiStringValue get(int j) { return get(new MultiStringValue(), j); }
    public MultiStringValue get(MultiStringValue obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
