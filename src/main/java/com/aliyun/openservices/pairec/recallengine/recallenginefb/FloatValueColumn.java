...
public final class FloatValueColumn extends Table {
  ...
  public static FloatValueColumn getRootAsFloatValueColumn(ByteBuffer _bb, FloatValueColumn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public FloatValueColumn __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startFloatValueColumn(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public FloatValueColumn get(int j) { return get(new FloatValueColumn(), j); }
    public FloatValueColumn get(FloatValueColumn obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
