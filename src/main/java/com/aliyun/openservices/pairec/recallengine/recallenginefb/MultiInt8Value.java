...
public final class MultiInt8Value extends Table {
  ...
  public static MultiInt8Value getRootAsMultiInt8Value(ByteBuffer _bb, MultiInt8Value obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public MultiInt8Value __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startMultiInt8Value(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public MultiInt8Value get(int j) { return get(new MultiInt8Value(), j); }
    public MultiInt8Value get(MultiInt8Value obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
